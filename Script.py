...
<b>ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ:</b>
<code>[Button Text](buttonurl:https://t.me/IKBRYTLinkz)</code>
<b>ᴀʟᴇʀᴛ ʙᴜᴛᴛᴏɴꜱ:</b>
...
★ Fʀᴇᴇ Sᴛᴏʀᴀɢᴇ: <code>{} MB</code></b>"""
    ...
    LOG_TEXT_G = """
    @IKBRYT_MOVIES_000091_bot #NewGroup
Gʀᴏᴜᴘ = {}(<code>{}</code>)
Tᴏᴛᴀʟ Mᴇᴍʙᴇʀs = <code>{}</code>
Aᴅᴅᴇᴅ Bʏ - {}"""

    LOG_TEXT_P = """
    @IKBRYT_MOVIES_000091_bot #NewUser
ID - <code>{}</code>
Nᴀᴍᴇ - {}"""
...
╰━━━━━━━━━━━━━━━➣ """
 ...
 /unpin :- ᴛᴏ ᴜɴᴩɪɴ ᴛʜᴇ ᴄᴜʀʀᴇᴇɴᴛ ᴩɪɴɴᴇᴅ ᴍᴇꜱꜱᴀɢᴇ</b>"""
    ...
    RESTART_TXT = """
@IKBRYT_MOVIES_000091_bot <b>Bᴏᴛ Rᴇsᴛᴀʀᴛᴇᴅ !
...
ஏய் <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 படி 1: இந்த @IKBRYTLinkz போட் உங்கள் குழுவை நிர்வாகியாக்குங்கள்
...
హే <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 దశ 1: ఈ @IKBRYTLinkz బాట్‌ని మీ సమూహానికి నిర్వహించండి
...
अरे <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 चरण 1: इस @IKBRYTLinkz बॉट को अपने समूह में प्रशासित करें
...
ഹേയ് <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 ഘട്ടം 1: ഈ @IKBRYTLinkz ബോട്ട് നിങ്ങളുടെ ഗ്രൂപ്പിലേക്ക് നൽകുക
...
നിങ്ങളുടെ ടീം വീഡിയോ ശേഖരണവും പരിശീലിപ്പിക്കും..."""
 ...
 مرحلہ 1: اپنے گروپ میں اس @IKBRYTLinkz بوٹ کا انتظام کریں۔
...
અરે <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 પગલું 1: તમારા જૂથમાં આ @IKBRYTLinkz બોટનું સંચાલન કરો
...
ಹೇ {message.from_user.mention}
 ...
 ಹಂತ 1: ಈ @IKBRYTLinkz ಬೋಟ್ ಅನ್ನು ನಿಮ್ಮ ಗುಂಪಿಗೆ ನಿರ್ವಹಿಸಿ
...
আরে <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 ধাপ 1: আপনার গ্রুপে এই @IKBRYTLinkz বট পরিচালনা করুন
